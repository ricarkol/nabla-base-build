...
# Example:
# bash run_single_rump_qemu_ext2.sh read5.med pm_data log.lfs
...

{
	...
	source ../rumprun/obj/config-PATH.sh && rumprun kvm -g '-nographic -vga none' -i -M 1024 -b ${logfile},/pm_data -- postmark.bin /pm_data/benchmark.${workload}
